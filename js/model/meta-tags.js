...
const SUGGESTED_META = [
       META_IMPLIES, 
       META_TODO, META_DONE,
       META_LIST_BULLETED, META_LIST_NUMBERED,
       META_UNFOLDED, META_FOLDED,
       META_DATE_HEADLINE,
       META_GOTO, META_EMBED,
       META_USERNAME, META_PASSWORD, META_EMAIL,
       META_PRIVATE, META_HIDE, META_COPYABLE,
       META_MARKDOWN, META_CSV, META_JSON,
       META_MONOSPACE, META_MONOSPACE_DARK, META_SHELL,
       META_LATEX, META_UML,
       META_MATRIX,
       META_QR,
       META_HTML,
       META_TEXT_ONLY,
       META_BOLD, META_ITALIC, META_STRIKETHROUGH,
       META_HEADING,
       META_RED, META_GREEN, META_BLUE, META_GREY,
       META_HIDDEN
];